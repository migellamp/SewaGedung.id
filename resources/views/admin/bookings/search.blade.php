...
<div class="card">
    ...
    <div class="card-body">
        ...
        @if($rooms !== null)
                        ...
                        <tbody>
                            @foreach($rooms as $room)
                                <tr>
                                    ...
                                    <td>
                                        {{ $room->hourly_rate ? 'Rp' . number_format($room->hourly_rate, 2) : 'FREE' }}
                                    </td>
                                    <td>
            ...
            @else
                <p class="text-center">Tidak ada Gedung/Lokasi yang tersedia pada tanggal yang dipilih</p>
            @endif
        @endif
    </div>
</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Pemesanan Gedung </h5>
            ...
            <div class="modal-body">
                <form action="{{ route('admin.bookRoom') }}" method="POST" id="bookingForm">
                    ...
                    <div class="form-group">
                        <label for="recurring_until">Tanggal Pembayaran</label>
                        <input class="form-control date">
                    </div>
                    <div class="form-group">
                        <label for="recurring_until">Pemesanan Berulang?</label>
...
$('#bookRoom').on('show.bs.modal', function (event) {
    ...
    modal.find('.modal-title').text('Pemesanan Gedung ' + button.parents('tr').children('.room-name').text());
